...
"""
    ...
    try:
        ...
        df.to_csv(os.path.join("output", "chronologies", f"cronologia_hab_txt_{fecha_final}.txt"), sep= "")
    except Exception as e:
        logging.error(e)


    try:
        df = hook.get_pandas_df(script2)
        
        df.to_excel(os.path.join("output", "chronologies", f"cronologia_hab_xlsx_{fecha_final}.xlsx"))
    except Exception as e:
        logging.error(e)
